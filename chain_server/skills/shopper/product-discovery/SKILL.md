...
- "Do you have water-resistant bags?" requires `unadvertised_requirements: ["water resistance"]`; an empty object is not faithful to that request. Only explicitly optional or preferred wording may remain a soft semantic preference.

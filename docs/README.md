...
- **[Observability](OBSERVABILITY.md)** - Tracing the agent: OpenTelemetry, NeMo Relay, and Phoenix
...
| [Observability](OBSERVABILITY.md) | Trace a turn and a session: what each producer records, and how to turn it on | Developers, operators |
